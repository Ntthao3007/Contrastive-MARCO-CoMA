...
from transformers import GPT2Tokenizer, GPT2LMHeadModel, BartForConditionalGeneration, BartTokenizer, BartModel
...
parser.add_argument('--lm_name',default="hallisky/bart-base-nontoxic-expert", type=str)
...
parser.add_argument('--save_folder',default="/home/ubuntu/20thao.nt/TST/count-style-transfer/output_dir_marco/", type=str)
...
if mapping:
    ...
    # model = BartModel.from_pretrained(lm_name)
    model.to(device)
